...
export default class TeamStatsService implements IIpcTeamStatsService {
	...
	static aggregate(stats: UniqueTeamStats[]): UniqueTeamStats | undefined {
		...
		const relevantStats = stats.filter(
			(uts) =>
				uts.matches_played >
				cfg.stats.ignoreTeamStatsWithGamesPlayedLowerThen,
		);
		...
		return {
			...
			total_goal_count_home: meanBy(
				relevantStats,
				"total_goal_count_home",
			),
			total_goal_count_away: meanBy(
				relevantStats,
			...
			minutes_per_goal_scored: meanBy(
				relevantStats,
			...
			average_possession_home: meanBy(
				relevantStats,
				"average_possession_home",
			),
			average_possession_away: meanBy(
				relevantStats,
			...
			shots_off_target_home: meanBy(
				relevantStats,
				"shots_off_target_home",
			),
			shots_off_target_away: meanBy(
				relevantStats,
			...
			draw_at_half_time_home: meanBy(
				relevantStats,
				"draw_at_half_time_home",
			),
			draw_at_half_time_away: meanBy(
				relevantStats,
			...
			over05_percentage_home: meanBy(
				relevantStats,
				"over05_percentage_home",
			),
			over15_percentage_home: meanBy(
				relevantStats,
				"over15_percentage_home",
			),
			over25_percentage_home: meanBy(
				relevantStats,
				"over25_percentage_home",
			),
			over35_percentage_home: meanBy(
				relevantStats,
				"over35_percentage_home",
			),
			over45_percentage_home: meanBy(
				relevantStats,
				"over45_percentage_home",
			),
			over55_percentage_home: meanBy(
				relevantStats,
				"over55_percentage_home",
			),
			over05_percentage_away: meanBy(
				relevantStats,
				"over05_percentage_away",
			),
			over15_percentage_away: meanBy(
				relevantStats,
				"over15_percentage_away",
			),
			over25_percentage_away: meanBy(
				relevantStats,
				"over25_percentage_away",
			),
			over35_percentage_away: meanBy(
				relevantStats,
				"over35_percentage_away",
			),
			over45_percentage_away: meanBy(
				relevantStats,
				"over45_percentage_away",
			),
			over55_percentage_away: meanBy(
				relevantStats,
			...
			under05_percentage_home: meanBy(
				relevantStats,
				"under05_percentage_home",
			),
			under15_percentage_home: meanBy(
				relevantStats,
				"under15_percentage_home",
			),
			under25_percentage_home: meanBy(
				relevantStats,
				"under25_percentage_home",
			),
			under35_percentage_home: meanBy(
				relevantStats,
				"under35_percentage_home",
			),
			under45_percentage_home: meanBy(
				relevantStats,
				"under45_percentage_home",
			),
			under55_percentage_home: meanBy(
				relevantStats,
				"under55_percentage_home",
			),
			under05_percentage_away: meanBy(
				relevantStats,
				"under05_percentage_away",
			),
			under15_percentage_away: meanBy(
				relevantStats,
				"under15_percentage_away",
			),
			under25_percentage_away: meanBy(
				relevantStats,
				"under25_percentage_away",
			),
			under35_percentage_away: meanBy(
				relevantStats,
				"under35_percentage_away",
			),
			under45_percentage_away: meanBy(
				relevantStats,
				"under45_percentage_away",
			),
			under55_percentage_away: meanBy(
				relevantStats,
				"under55_percentage_away",
			),
			over05_count_half_time: meanBy(
				relevantStats,
				"over05_count_half_time",
			),
			over15_count_half_time: meanBy(
				relevantStats,
				"over15_count_half_time",
			),
			over25_count_half_time: meanBy(
				relevantStats,
			...
			corners_per_match_home: meanBy(
				relevantStats,
				"corners_per_match_home",
			),
			corners_per_match_away: meanBy(
				relevantStats,
			...
			draw_percentage_overall: meanBy(
				relevantStats,
			...
			loss_percentage_ovearll: meanBy(
				relevantStats,
