...
public class PredictionQualityService extends MongoService<BetPredictionQuality> {
	...
	/**
	 * Method is intended for use when recomputing all bet prediction qualities. It updates the revision of matches that don't have a revision and the
	 * revision of bet prediction qualities that have the IN_RECOMPUTATION revision to the next revision.
	 */
	@Transactional
	...
	/**
	 * Method is intended for use when computing bet prediction qualities for matches without a revision. It updates the revision of matches with no
	 * revision with the latest revision.
	 */
	@Transactional
