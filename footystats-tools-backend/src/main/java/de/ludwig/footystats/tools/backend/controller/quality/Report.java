...
/**
 * Just brackets around a minimal set of bet quality data. The structure represents the way how data is displayed
 * inside the frontend. We have a list with all bets and some information about how many of them were checked for quality.
 * <p>
 * Then there are graphs that show the percent distribution for on bet (depending on the choosen one from the list).
