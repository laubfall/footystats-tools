...
public class DownloadConfigServiceTest {
	@Autowired
	...
	@Test
	public void match_dl_bitmask_and_last_download_is_null_or_older_thirty_days(){
		...
		var bundesliga2 = new DownloadCountryLeagueStatsConfig("Germany", "2. Bundesliga", 4711, "2022/" + currentYear, null, null, null, null, null, null);
		...
		var bundesliga3 = new DownloadCountryLeagueStatsConfig("Germany", "3. Bundesliga", 4711, "2022/" + currentYear, 1, dlOldThenThirtyDays, dlOldThenThirtyDays, dlOldThenThirtyDays, dlOldThenThirtyDays, dlOldThenThirtyDays);
	...
	@Test
	public void season_does_not_match(){
	...
	@Test
	public void last_download_to_young_so_no_match(){
		var currentYear = LocalDate.now().getYear();
		// Should be inside the result set cause last download of player stats is older then thirty days.
