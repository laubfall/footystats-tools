...
@Import({FootystatsProperties.class, DefaultBatchConfiguration.class, JunitJacksonConfiguration.class, MongoConfiguration.class})
...
@ComponentScan(value = {"de.footystats.tools.services"},
