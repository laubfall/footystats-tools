...
class LeaguePositionInfluencerTest {
	...
	static Object[][] leaguePositionInfluencerPrecheckSource() {
		return new Object[][]{
			{10, Bet.OVER_ZERO_FIVE, new HomeTeamLeaguePosInfluencer(), teamStatsBuilder(2, 5,
				10), null, PrecheckResult.OK},
			{10, Bet.OVER_ZERO_FIVE, new HomeTeamLeaguePosInfluencer(), teamStatsBuilder(0, 0,
				10), null, PrecheckResult.NOT_ENOUGH_INFORMATION},
			{10, Bet.OVER_ZERO_FIVE, new HomeTeamLeaguePosInfluencer(), teamStatsBuilder(2, 11,
				10), null, PrecheckResult.INVALID_STATS},
			{10, Bet.OVER_ZERO_FIVE, new HomeTeamLeaguePosInfluencer(), teamStatsBuilder(11, 2,
				10), null, PrecheckResult.INVALID_STATS},
			{10, Bet.OVER_ZERO_FIVE, new HomeTeamLeaguePosInfluencer(), null, teamStatsBuilder(2, 5,
			...
			{10, Bet.OVER_ZERO_FIVE, new AwayTeamLeaguePosInfluencer(), teamStatsBuilder(2, 5,
				10), null, PrecheckResult.NOT_ENOUGH_INFORMATION},
	...
	void leaguePositionInfluencerCalculate(int homeTeamLeaguePosition, int awayTeamLeaguePosition, int numberOfClubs, Bet bet,
		...
		MatchStats matchStats = MatchStats.builder().dateGmt(LocalDateTime.now()).country(germany).league(
